...
const MethodSection = () => (
  <section id="methode" className="py-32 bg-background px-4">
    <div className="container mx-auto max-w-5xl">
      ...
      <p className="text-center text-muted-foreground font-inter mb-20 max-w-xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {tiles.map((t, i) => (
          <div key={i} className="bg-card border border-border rounded-2xl p-10 shadow-card hover:shadow-card-hover hover:border-primary/30 transition-all duration-300 group">
