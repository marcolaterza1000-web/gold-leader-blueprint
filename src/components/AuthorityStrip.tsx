...
const AuthorityStrip = () => (
  <section className="bg-card py-6 border-y border-border/50">
    <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-6 md:gap-14 px-4">
      {items.map((item, i) => (
